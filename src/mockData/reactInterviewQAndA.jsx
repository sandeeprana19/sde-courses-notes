      ...
      },
      {
        ...
        answer: (
          <div className="flex flex-col gap-y-2">
            <p>A. 💡 Quick Recall (15 sec)</p>
            <p>
              I use async/await inside function in React like event handler,
              helper function and function called inside useEffect hook callback
              function. And I don’t make useEffect hook callback function async
              instead I define an async function inside it and then I call that
              function. Or, I can also define async function outside of
              useEffect hook callback function & then call it inside useEffect
              callback function.
            </p>
          </div>
        ),
